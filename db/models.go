...
type Device struct {
	...
	B2BUASIPUser      string    `gorm:"type:varchar(255);uniqueIndex;not null" json:"b2bua_sip_user"`
...
type PendingCall struct {
	...
	SIPCallID  string    `gorm:"type:varchar(255);not null" json:"sip_call_id"`
	SIPFrom    string    `gorm:"type:text;not null" json:"sip_from"`
	SIPTo      string    `gorm:"type:text;not null" json:"sip_to"`
	CallerURI  string    `gorm:"type:text;not null" json:"caller_uri"`
	CallerName string    `gorm:"type:varchar(255)" json:"caller_name"`
	SDPOffer   string    `gorm:"type:text" json:"sdp_offer"`
